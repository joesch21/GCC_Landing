...
| Conditional BTC/BNB/SOL coefficients/intervals | LE1-B9 MULTI_CRYPTO | PARTIAL; BTC/SOL intervals cross zero | `gcc-opportunity-research.json.transmission` | Coefficient bars | §12 |
| Direct WBNB 48/50, zero profitable, aggregate −1.419261899 WBNB, median −0.029705485 | GCC-NET-2C historical BSC fork | NOT_SUPPORTED for tested family | solver metrics | Direct WBNB solver | §14 |
| Fragmented pools, recurring dispersion/compression, corrective activity | LE1-B7/B8/B10 and transaction research | ESTABLISHED within historical scope | evidence maps | Evidence/topology | §§7–9 |
